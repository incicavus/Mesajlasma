...
namespace Mesajlasma
{
    public partial class Form1 : Form
    {
        ...
        //hem form açıldığında hemde kişi ekle/sil işlemlerinde tekrar ihtiyaç duyulabilceği için metot içerisinde yazıldı.
        void ShowContactList()
        {
            ...
            //{
            //    lbContacts.Items.Add(((Contact)Fihrist.contacts[i]).NickName);
            //}

            //contact içinde sadece Contact nesnesi varsa 
        ...
        {
            if (!string.IsNullOrEmpty(txtName.Text) && !string.IsNullOrEmpty(label.Text) && !string.IsNullOrEmpty(labell.Text))
            {
        ...
        {
            txtSent.Clear();//gönderileni önce temizlicek.
